...
import { CreateFacilityDto, InstallationType } from "src/types/facility";
import { useGetCompanies } from "src/hooks/company.hook";
...
import { useCreateFacility, useGetStates } from "src/hooks/facility.hook";
...
interface FacilityFormProps {
  formik: FormikProps<CreateFacilityDto>;
}
...
const FacilityForm: React.FC<FacilityFormProps> = ({ formik }) => {
                ...
                <Col lg={12}>
                  <div className="border rounded p-4 mb-4">
                      ...
                      <Col md={6}>
                        <FormGroup>
                          <Label for="omlNumber" className="fw-semibold">
                            OML Number <span className="text-danger">*</span>
                          </Label>
                          <Input
                            type="text"
                            id="omlNumber"
                      ...
                      <Col md={6}>
                        <FormGroup>
                          ...
                          >
                            ...
                            {installationTypes.map((type: InstallationType) => (
                    ...
                    <Row>
                      <Col md={6}>
                        <FormGroup>
                          <Label for="facilityTypeId" className="fw-semibold">
                    ...
                    <Row>
                      <Col md={6}>
                        <FormGroup>
                          ...
                          {formik.touched.stateId && formik.errors.stateId && (
                            <FormFeedback>{formik.errors.stateId}</FormFeedback>
                          )}
                        </FormGroup>
                      </Col>
                      ...
                      <Col md={6}>
                        <FormGroup>
                          ...
                          {formik.touched.lgaId && formik.errors.lgaId && (
                            <FormFeedback>{formik.errors.lgaId}</FormFeedback>
                          )}
                        </FormGroup>
                      </Col>
                    </Row>
